...
class Ui_APP(object):
    def setupUi(self, APP):
        ...
        self.horizontalLayoutWidget = QWidget(APP)
        self.horizontalLayoutWidget.setObjectName(u"horizontalLayoutWidget")
        self.horizontalLayoutWidget.setGeometry(QRect(170, 570, 195, 80))
        self.horizontalLayout = QHBoxLayout(self.horizontalLayoutWidget)
        self.horizontalLayout.setObjectName(u"horizontalLayout")
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.freshBtn = QPushButton(self.horizontalLayoutWidget)
        self.freshBtn.setObjectName(u"freshBtn")

        self.horizontalLayout.addWidget(self.freshBtn)

        self.button = QPushButton(self.horizontalLayoutWidget)
    ...
    def retranslateUi(self, APP):
        ...
        self.freshBtn.setText(QCoreApplication.translate("APP", u"\u5237\u65b0", None))
